              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:divyajain2405@gmail.com" className="text-blue-600 hover:text-blue-800 transition-colors">
                      divyajain2405@gmail.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="https://www.linkedin.com/in/divyajain2405/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 transition-colors">
                      divyajain2405
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="https://github.com/djain2405" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-gray-900 transition-colors">
                      djain2405
                    </a>
                  </div>
                </div>
